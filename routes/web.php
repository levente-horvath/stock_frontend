...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/auth-test', [SavedPlotController::class, 'test']);
});
...
// Emergency fix route - one time use
Route::get('/api/fix-plots-ownership', [SavedPlotController::class, 'fixOwnership']);
